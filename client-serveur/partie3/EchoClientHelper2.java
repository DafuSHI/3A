...
/**/  System.out.println("Connection request made");
   ...
   public String getEcho( String message) throws SocketException,
    ...
    public String getAdd(String message) throws SocketException,
      IOException{     
      String add = "";    
      message="ADD "+message;
      mySocket.sendMessage( message);
	   // now receive the echo
      add = mySocket.receiveMessage();
      return add;
   } 
   
   public String getMul(String message) throws SocketException,
      IOException{     
      String mul = "";    
      message="MUL "+message;
      mySocket.sendMessage( message);
	   // now receive the echo
      mul = mySocket.receiveMessage();
      return mul;
   } 
